...
<%
 ...
 rs=Classess.CommonCode.runQuery("select * from empreg where USERID='"+uid+"'");
while(rs.next())
{
f1=rs.getString(1);
f2=rs.getString(2);
...
<center><a href="./updatepersonal.jsp">Personal Details Edit</a></center>
...
<%
 ...
 rs1=Classess.CommonCode.runQuery("select * from education where USERID='"+uid+"'");
while(rs1.next())
{
g1=rs1.getString(1);
g2=rs1.getString(2);
...
rs1.close();
%>
<center><a href="./modiempeducation.jsp">Education Details Edit</a></center>
<hr>
...
<%
 ...
 rs2=Classess.CommonCode.runQuery("select * from skills where USERID='"+uid+"'");
while(rs2.next())
{
h1=rs2.getString(1);
h2=rs2.getString(2);
...
rs2.close();
%>
<center><a href="./updatepersonal.jsp">Skills Details Edit</a></center>
<hr>
...
<%
 ...
 rs3=Classess.CommonCode.runQuery("select * from experience where USERID='"+uid+"'");
while(rs3.next())
{
i1=rs3.getString(1);
i2=rs3.getString(2);
...
<%
ResultSet rs4=Classess.CommonCode.runQuery("select * from PROJECTS where USERID='"+uid+"'");
while(rs4.next())
       {
%>
<center><a href="./exper.jsp">Experience Details Edit</a></center>
<hr>
...
<%}%>
<p>&nbsp;</p>
<center><a href="./updateuserproject.jsp">Project Details Edit</a></center>
<hr>
